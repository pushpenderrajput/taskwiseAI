...
const initialTasks: Task[] = [
  ...
  },
  {
    id: 'TASK-7878',
    title:
      'Try to calculate the EXE feed, maybe it will copy the open-source XML bus!',
    status: 'To-Do',
    priority: 'Medium',
  ...
  },
  {
    id: 'TASK-3432',
    title:
      'If we override the interface, we can get to the SMTP feed through the virtual EXE interface!',
    status: 'Completed',
    priority: 'High',
    createdAt: new Date(
  ...
  },
  {
    id: 'TASK-1212',
    title:
      "I'll back up the wireless SSL protocol, that should mobile the XSS firewall!",
    status: 'Completed',
    priority: 'Low',
    createdAt: new Date(
  ...
  },
  {
    id: 'TASK-5465',
    title:
      'The AI protocol is down, navigate the redundant driver so we can calculate the microchip!',
    status: 'To-Do',
    priority: 'Low',
